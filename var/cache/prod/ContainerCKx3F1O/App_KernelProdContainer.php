...
class App_KernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\ApcuAdapter('iHSNngEdzf', 0, $this->getParameter('container.build_id'));
    ...
    {
        return $this->privates['App\\Service\\MarkdownHelper'] = new \App\Service\MarkdownHelper(($this->services['markdown.parser'] ?? ($this->services['markdown.parser'] = new \Knp\Bundle\MarkdownBundle\Parser\Preset\Max())), ($this->services['cache.app'] ?? $this->getCache_AppService()), false);
    }
