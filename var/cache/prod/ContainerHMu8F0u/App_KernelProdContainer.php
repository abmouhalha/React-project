...
class App_KernelProdContainer extends Container
{
    ...
    protected function getCommentControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.opCqDVD'] ?? $this->get_ServiceLocator_OpCqDVDService())->withContext('App\\Controller\\CommentController', $this));
    ...
    {
        $this->services['App\\Controller\\QuestionController'] = $instance = new \App\Controller\QuestionController();

        $instance->setContainer(($this->privates['.service_locator.opCqDVD'] ?? $this->get_ServiceLocator_OpCqDVDService())->withContext('App\\Controller\\QuestionController', $this));
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rh7-rCcq6D', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5fpfQOcCMQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCacheWarmerService()
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['webpack_encore.entrypoint_lookup.cache_warmer'] ?? ($this->privates['webpack_encore.entrypoint_lookup.cache_warmer'] = new \Symfony\WebpackEncoreBundle\CacheWarmer\EntrypointCacheWarmer(['_default' => (\dirname(__DIR__, 4).'/public/build/entrypoints.json')], ($this->targetDir.''.'/webpack_encore.cache.php'))));
    ...
    protected function getServicesResetterService()
    {
        return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
            ...
            return 0 + (int) (isset($this->services['cache.app'])) + (int) (isset($this->services['cache.system'])) + (int) (false) + (int) (false) + (int) (false) + (int) (false) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->privates['monolog.handler.main'])) + (int) (isset($this->privates['monolog.handler.console'])) + (int) (isset($this->privates['monolog.handler.deprecation'])) + (int) (isset($this->privates['monolog.handler.deprecation_filter'])) + (int) (isset($this->privates['webpack_encore.tag_renderer'])) + (int) (false) + (int) (isset($this->privates['webpack_encore.entrypoint_lookup[_default]']));
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'monolog.handler.main' => [0 => 'reset'], 'monolog.handler.console' => [0 => 'reset'], 'monolog.handler.deprecation' => [0 => 'reset'], 'monolog.handler.deprecation_filter' => [0 => 'reset'], 'webpack_encore.tag_renderer' => [0 => 'reset'], 'cache.webpack_encore' => [0 => 'reset'], 'webpack_encore.entrypoint_lookup[_default]' => [0 => 'reset']]);
    }
    ...
    protected function getTwigService()
    {
        ...
        $c->addParser(($this->services['markdown.parser'] ?? ($this->services['markdown.parser'] = new \Knp\Bundle\MarkdownBundle\Parser\Preset\Max())), 'default');
    ...
    /*
     * Gets the private '.service_locator.opCqDVD' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_OpCqDVDService()
    {
        return $this->privates['.service_locator.opCqDVD'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /*
     * Gets the private '.service_locator.x.MG8kv' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_X_MG8kvService()
    {
        return $this->privates['.service_locator.x.MG8kv'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'twigEnvironment' => ['services', 'twig', 'getTwigService', false],
        ], [
            'twigEnvironment' => '?',
        ]);
    }
    ...
    {
        return $this->privates['App\\Service\\MarkdownHelper'] = new \App\Service\MarkdownHelper(($this->services['markdown.parser'] ?? ($this->services['markdown.parser'] = new \Knp\Bundle\MarkdownBundle\Parser\Preset\Max())), ($this->services['cache.app'] ?? $this->getCache_AppService()));
    }
    ...
    protected function getArgumentResolver_ServiceService()
    {
        return $this->privates['argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\QuestionController::homepage' => ['privates', '.service_locator.x.MG8kv', 'get_ServiceLocator_X_MG8kvService', false],
    ...
    {
        $this->privates['console.command.cache_pool_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolListCommand([0 => 'cache.app', 1 => 'cache.system', 2 => 'cache.validator', 3 => 'cache.serializer', 4 => 'cache.annotations', 5 => 'cache.property_info', 6 => 'cache.webpack_encore']);
